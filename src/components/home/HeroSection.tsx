  ...
  return (
    <section className="py-4 md:py-6 lg:py-8">
      <div className="container mx-auto px-2 md:px-4 text-center">
        <h1 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-purple-600 mb-1 md:mb-2">
          AI Meets Hospitality
        </h1>
        <h2 className="text-xl md:text-2xl lg:text-3xl mb-2 md:mb-3">
